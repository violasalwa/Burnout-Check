...
<style>
/* ============================================================
   dosen/mahasiswa.blade.php — Custom CSS
...
/* ── PAGINATION ───────────────────────────────────────────── */
/* Override default Laravel pagination agar sesuai tema */
...
/* Tailwind-based pagination (Laravel default) */
...
/* Simple pagination (non-Tailwind) */
.pagination {
    display: flex;
    gap: 0.3rem;
    list-style: none;
...
@media (max-width: 768px) {
    ...
    /* Card tabel — padding nol, tabel scroll horizontal */
    .card:first-of-type {
        padding: 1.25rem 0;
        overflow: hidden;
    }
...
<div class="card">
    <a href="{{ route('dosen.dashboard') }}" class="btn">Kembali</a>
</div>
@endsection
